...
get_is_protected = lambda conservation_status: True if conservation_status == 'No Intervention' else False 
...
chi2, pval, dof, expeced = chi2_contingency(contingency)
print(pval)
...
chi2, pval, dof, expeced = chi2_contingency(contingency2)
print(pval)
...
get_is_sheep = lambda common_names: True if 'Sheep' in common_names else False 
...
sheep_observation = pd.merge(sheep_species, observations)
...
ax = plt.subplot()
plt.bar(range(len(obs_by_park.observations)),
